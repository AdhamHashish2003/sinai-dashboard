...
const REAL_CONNECTIONS = [
  { platform: "instagram", username: "undercurrenthq", bio: "The force beneath the surface. Predictions | Analysis | Education", followers: 1232, following: 12, posts: 69, engagementRate: 4.8 },
  { platform: "instagram", username: "sandsofgiza", bio: "", followers: 5, following: 0, posts: 0, engagementRate: 0 },
  { platform: "instagram", username: "imperiumstoicc", bio: "", followers: 8, following: 8, posts: 19, engagementRate: 0 },
  { platform: "instagram", username: "ummaharchives.co", bio: "📖 The history they never taught you 🤲 Daily Quran · Duas · Islamic History", followers: 17, following: 13, posts: 34, engagementRate: 0 },
];
